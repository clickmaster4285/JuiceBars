    ...
    <section ref={sectionRef} className="section-padding">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <span className="gradient-bg-sunset text-primary-foreground px-4 py-1.5 rounded-full font-display text-sm font-semibold">Case Studies</span>
        ...
        <div className="juice-card overflow-hidden case-el">
          <div className="grid lg:grid-cols-2">
            <div className="relative">
              <img src={caseStudyImg} alt="Tropical Bliss Juice Bar" className="w-full h-full object-cover min-h-[300px]" loading="lazy" width={800} height={600} />
              <div className="absolute inset-0 gradient-bg-hero/20" />
              <img src={about1} alt="Interior" className="absolute bottom-4 right-4 w-32 h-24 rounded-xl object-cover shadow-card border-2 border-card" loading="lazy" width={800} height={600} />
            </div>
            <div className="p-8 md:p-12">
              ...
              <div className="grid grid-cols-2 gap-4">
                {metrics.map((m, i) => (
                  <div key={i} className="case-el rounded-xl bg-muted/50 p-4">
